 ...
 * @version 2016-05-06
 */
public class DocBloodCapacity extends DataEntity<DocBloodCapacity> {
	...
	public DocBloodCapacity() {
		super();
	}

	public DocBloodCapacity(String id){
		super(id);
	}

	@Length(min=1, max=60, message="申请单号长度必须介于 1 和 60 之间")
	...
	@Length(min=0, max=10, message="申请单子号长度必须介于 0 和 10 之间")
	...
	@Length(min=0, max=10, message="用血安排,1:急诊，2：计划，3：备血长度必须介于 0 和 10 之间")
