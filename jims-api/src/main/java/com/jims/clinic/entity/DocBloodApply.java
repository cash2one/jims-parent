 ...
 * @version 2016-05-06
 */
public class DocBloodApply extends DataEntity<DocBloodApply> {
	...
	private List<DocBloodCapacity> list=new ArrayList<DocBloodCapacity>();


	public DocBloodApply() {
		super();
	}

	public DocBloodApply(String id){
		super(id);
	}
	...
	@Length(min=0, max=100, message="病人来源，市区：1；郊县：2，外省市：3；港澳台：4长度必须介于 0 和 100 之间")
	...
	@Length(min=0, max=100, message="划价标志长度必须介于 0 和 100 之间")
	...
	@Length(min=0, max=100, message="hbsag长度必须介于 0 和 100 之间")
	...
	@Length(min=0, max=100, message="hcv长度必须介于 0 和 100 之间")
	...
	@Length(min=0, max=100, message="hiv长度必须介于 0 和 100 之间")
	...
	@Length(min=0, max=100, message="梅毒长度必须介于 0 和 100 之间")
	...
	@Length(min=0, max=100, message="辐照血长度必须介于 0 和 100 之间")
	...
	@Length(min=0, max=100, message="预输血型长度必须介于 0 和 100 之间")
	...
	public List<DocBloodCapacity> getList() {
		return list;
	}

	public void setList(List<DocBloodCapacity> list) {
		this.list = list;
	}
