 ...
 */
 ...
 -- 采购计划调整菜单添加
 INSERT INTO menu_dict( id, menu_name, href, icon, sort, target, pid, menu_level, remarks, update_by, create_by, update_date, del_flag, create_date ) VALUES (sys_guid(), '采购计划调整', '/modules/phstock/drug-buy-plan-audit.html', '1', 1, '1', '065969698a724445b2c03085aad8dfcd', '1', null, null, null, sysdate, '0', sysdate );
--项目类别
