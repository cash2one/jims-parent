...
(
  ...
  BIRTHDAY        DATE,
  FEE_TYPE        VARCHAR2(8),
  PAT_SOURCE      VARCHAR2(100),
  BLOOD_PAPER     VARCHAR2(8),
  BLOOD_INUSE     VARCHAR2(4),
  BLOOD_DIAGNOSE  VARCHAR2(80),
  BLOOD_TABOO     VARCHAR2(40),
  HEMATIN         NUMBER(5),
  PLATELET        NUMBER(5),
  LEUCOCYTE       NUMBER(5),
  PAT_BLOOD_GROUP VARCHAR2(4),
  RH              VARCHAR2(4),
  BLOOD_SUM       NUMBER(5),
  APPLY_DATE      DATE,
  GATHER_DATE     DATE,
  DIRECTOR        VARCHAR2(20),
  PHYSICIAN       VARCHAR2(20),
  DOCTOR          VARCHAR2(20),
  PRICE           VARCHAR2(1),
  HCT             NUMBER(6,2),
  ALT             NUMBER(6,2),
  ...
  HIV             VARCHAR2(2),
  ANTI_MD         VARCHAR2(2),
  SHINE_BLOOD     VARCHAR2(2),
  PRE_BLOOD_TYPE  VARCHAR2(2),
