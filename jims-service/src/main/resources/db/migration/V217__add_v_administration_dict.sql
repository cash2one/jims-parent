...
select distinct A."ID",A."ADMINISTRATION_CODE",A."ADMINISTRATION_NAME",A."INPUT_CODE",A."INP_OUTP_FLAG",A."REMARKS",A."UPDATE_BY",A."CREATE_BY",A."UPDATE_DATE",A."DEL_FLAG",A."CREATE_DATE",B.AMOUNT,B.ITEM_SPEC,B.UNITS,B.PRICE,B.ORG_ID from
