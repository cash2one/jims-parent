...
alter table EMR_DIAGNOSIS add ORG_ID VARCHAR2(64);
alter table EMR_DIAGNOSIS add CLINIC_ID VARCHAR2(64);
...
comment on column EMR_DIAGNOSIS.DIAGNOSIS_DATE
  is '诊断日期';
  comment on column EMR_DIAGNOSIS.ORG_ID
  is '组织机构';
  comment on column EMR_DIAGNOSIS.CLINIC_ID
  is '就诊Id';
