...
public interface ClinicMasterDao extends CrudDao<ClinicMaster> {
     ...
     * @author zhaoning
     */
    public List<ClinicMaster>  getClinicBydoctor(@Param("visitDept")String visitDept,@Param("orgId")String orgId);
     ...
     * @author zhaoning
     */
    public List<ClinicMaster> getClinicMasterDiagnosed(@Param("visitDept")String visitDept,@Param("orgId")String orgId);
