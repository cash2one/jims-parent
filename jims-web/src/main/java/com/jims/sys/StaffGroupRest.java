...
public class StaffGroupRest {
    ...
    @GET
    public List<StaffGroupClassDict> findAllListByOrgId(@QueryParam("orgId") String orgId) {
        return staffGroupApi.findAllListByOrgId(orgId);
    }
    ...
    @GET
    public List<StaffGroupDict> findListGroupDict(@QueryParam("id") String id) {
        return staffGroupApi.findListGroupDict(id);
    }
