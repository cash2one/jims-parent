...
public class StaffVsGroupRest {
     ...
     * 保存  增删改      工作组
     *
     * @param staffVsGrouplVo
     * @return
     * @author yangruidong
     */
    @Path("saveVsGroup")
    @POST
    public StringData saveVsGroup(StaffVsGroupVo<StaffVsGroup> staffVsGrouplVo) {
        List<StaffVsGroup> newUpdateDict = new ArrayList<StaffVsGroup>();
        newUpdateDict = staffVsGroupApi.saveVsGroup(staffVsGrouplVo);
