function onloadMethod(status){
    $('#orderList').datagrid({
        ...
        method:'GET',
        url:basePath+'/orders/getOrders?status='+status,
        remoteSort:false,
        idField:'id',
        ...
        columns:[[      //每个列具体内容
            ...
            {field:'billingAttr',title:'自',width:'10%',align:'center'},
            {field:'dosage',title:'剂量',width:'10%',align:'center'},
            {field:'dosageUnits',title:'单位',width:'10%',align:'center'},
            {field:'administration',title:'途径',width:'10%',align:'center'},
            {field:'frequency',title:'频次',width:'10%',align:'center'},
            {field:'freqDetail',title:'执行时间',width:'10%',align:'center'},
            {field:'',title:'阴阳',width:'10%',align:'center'},
            ...
            {field:'freqCounter',title:'次数',width:'10%',align:'center'},
            {field:'stopDoctor',title:'停止医生',width:'10%',align:'center'},
            {field:'stopNurse',title:'停止校対护士',width:'10%',align:'center'}
        ]]
    });
    //设置分页控件
