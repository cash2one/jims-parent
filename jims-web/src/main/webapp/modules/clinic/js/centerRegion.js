...
function userMenu(clinicMasterId,aBtn){
   ...
   // html+='<li><a   onclick="addTabs(\'10\',\'住院诊断\',\'/modules/clinic/emrDiagnosis/inDiagnosis.html\',this)"><span>住院诊断</span></a></li>';
    ...
    html+='<li><a   onclick="addTabs(\'15\',\'住院通知单\',\'/modules/clinic/notice/patHospitalNoticeList.html\',this)"><span>住院通知单</span></a></li>';
    html+='<li><a   onclick="addTabs(\'16\',\'出院通知单\',\'/modules/clinic/PreDischgedPats/PreDischgedPatsList.html\',this)"><span>出院通知单</span></a></li>';
