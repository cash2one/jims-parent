function onloadMethod() {
    $('#list_data').datagrid({
        ...
        fit: true,//自动大小
        url:basePath+'/PerformFreqDict/list',
        //sortName: 'code',
        //sortOrder: 'desc',
        remoteSort: false,
        idField: 'fldId',
        ...
        columns: [[      //每个列具体内容
            ...
            {field: 'freqDesc', title: '执行频率描述', width: '10%', align: 'center'},
            {field: 'freqCounter', title: '频率次数', width: '10%', align: 'center'},
            {field: 'freqInterval', title: '频率间隔', width: '18%', align: 'center'},
            {field: 'freqIntervalUnits', title: '频率间隔单位', width: '18%', align: 'center'},
        ...
        toolbar: [{
            ...
            iconCls: 'icon-add',
            handler: function () {
                $("#performFreqDictForm").form('clear');
...
function del(id) {
    $.ajax({
        'type': 'POST',
        'url': basePath + '/PerformFreqDict/del',
...
function get(id) {
    ...
    $.ajax({
        'type': 'post',
        'url': basePath + '/PerformFreqDict/get',
        'contentType': 'application/json',
        'data': id = id,
        'dataType': 'json',
        'success': function (data) {
