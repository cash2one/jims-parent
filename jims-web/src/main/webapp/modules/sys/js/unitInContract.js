function onloadMethod() {
    $('#list_data').datagrid({
        ...
        fit: true,//自动大小
        url:basePath+'/UnitInContract/list',
        //sortName: 'code',
        //sortOrder: 'desc',
        remoteSort: false,
        idField: 'fldId',
        ...
        columns: [[      //每个列具体内容
            ...
            {field: 'unitCode', title: '合同单位代码', width: '10%', align: 'center'},
            {field: 'unitName', title: '合同单位名称', width: '10%', align: 'center'},
            {field: 'inputCode', title: '输入码', width: '18%', align: 'center'},
            {field: 'address', title: '单位地址', width: '18%', align: 'center'},
            {field: 'unitType', title: '单位性质', width: '18%', align: 'center'},
            {field: 'subordinateTo', title: '隶属单位', width: '18%', align: 'center'},
            {field: 'distanceToHospital', title: '就医距离', width: '18%', align: 'center'},
            {field: 'regularNum', title: '在编人数', width: '18%', align: 'center'},
            {field: 'tempNum', title: '非编人数', width: '18%', align: 'center'},
            {field: 'retiredNum', title: '离退休人数', width: '18%', align: 'center'},
...
function del(id) {
    $.ajax({
        'type': 'POST',
        'url': basePath + '/UnitInContract/del',
...
function get(id) {
    ...
    $.ajax({
        'type': 'post',
        'url': basePath + '/UnitInContract/get',
        'contentType': 'application/json',
        'data': id = id,
        'dataType': 'json',
        'success': function (data) {
