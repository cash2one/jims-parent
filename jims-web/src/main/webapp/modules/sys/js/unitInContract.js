$(function () {
    ...
    $("#dg").datagrid({
        ...
        columns: [[
            ...
            {field: 'unitType', title: '单位性质', width: '10%', align: 'center',editor: {type: 'textbox',options:{required:true}}},
            {field: 'subordinateTo', title: '隶属单位', width: '10%', align: 'center',editor: {type: 'textbox',options:{required:true}}},
            {field: 'distanceToHospital', title: '就医距离', width: '10%', align: 'center',editor: {type: 'textbox',options:{required:true}}},
            ...
            {field: 'inputCodeWb', title: '五笔码', width: '10%', align: 'center',editor: {type: 'textbox',options:{required:true}}},
        ]],
