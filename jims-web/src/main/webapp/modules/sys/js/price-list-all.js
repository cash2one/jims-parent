...
$(function () {
    ...
    $("#dg").datagrid({
        ...
        url: basePath +'/price-list/list-all?orgId='+parent.config.org_Id,
        idField:'fldId',
        remoteSort:false,
    ...
    $("#searchBtn").on("click", function () {
        ...
        $.get(basePath +"/price-list/find-by-input-code-old?inputCode=" + inputCode+"&label="+label+"&orgId="+parent.config.org_Id, function (data) {
