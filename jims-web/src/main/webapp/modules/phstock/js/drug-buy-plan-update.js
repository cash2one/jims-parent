$(function () {
    ...
    var mergeLastCells = function () {
        ...
        $('#buyPlanTable').datagrid('mergeCells', {index: _index, field: 'buyNo', rowspan: null, colspan: 11})
        $('#buyPlanTable').datagrid('mergeCells', {index: _index, field: 'stockMoney', rowspan: null, colspan: 6})
    }
    ...
    var showDrugPriceWindow = function (drugPrices, drugDict) {
        ...
        var initData = function (drugPrice, drugDict) {
            ...
            //$('#buyPlanTable').datagrid('reference', planSelectIndex);
    ...
    var loadDrugPriceData = function (drugDict) {
        $.get('/service/drug-price/findList', {
