...
$(function () {
    ...
    //
    $('#global').layout('panel', 'north').panel('resize', {height: 'auto'});
    $('#global').layout('panel', 'south').panel('resize', {height: 'auto'});
    ...
    //                $("#drugNameDict").datagrid("loadData", {rows: []});
    //            } else {
    //                $.each(data, function (index, item) {
